      ...
      <div className="w-11/12 h-5/6 flex flex-col md:flex-row shadow-lg rounded-lg overflow-hidden">
        ...
        <section className="md:w-1/2 h-1/2 md:h-full flex flex-col justify-center p-6 bg-white">
          ...
          <p className="text-lg text-gray-700">
            ...
            home and office use, offering superior print quality, user-friendly
            design, and cost-efficient solutions. Enjoy reliable performance and
            comprehensive support with every purchase. Explore our range today
            and elevate your printing experience!
          </p>
          <div>
